...
var _etmc = {
  ...
  trackPageView: function(args) {
    ...
    if (this.org_id) {
      ...
      pageView.url = pageView.url || decodeURI(window.location.href);
  ...
  sendDataWithImage: function(endpoint, args) {
    ...
    if (this.insecure==true) protocolPrepend = 'http';
    if (this.first_party) {
      collect_url = this.first_party;
    } else {
      collect_url = 'nova.collect.igodigital.com';
    }
    var image_tag = '<img src="' + protocolPrepend + '://' + collect_url + '/c2/';
